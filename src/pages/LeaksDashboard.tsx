...
const LeaksDashboard = () => {
  ...
  return (
    <div className="scanlines flicker min-h-screen p-8">
      <button onClick={() => navigate("/home")} className="text-muted-foreground hover:text-primary transition-colors mb-8 flex items-center gap-2 cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {items.length === 0 && (
              <div className="red-box p-8 text-center col-span-full">
                ...
                <p className="text-muted-foreground text-xs mt-2">Click ADD to create an entry</p>
              </div>
            )}
          </div>
        </div>
